...
import { NutritionalStats } from '../../../lib/services/healthAnalyticsService';

interface NutritionalStatsChartProps {
  data: NutritionalStats[];
}

const COLORS: Record<string, string> = {
  'Severely Wasted': '#ef4444', // red-500
  'Wasted': '#f59e0b',          // amber-500
  'Normal': '#10b981',          // emerald-500
  'Overweight': '#3b82f6',      // blue-500
  'Obese': '#a855f7'            // purple-500
};
...
export const NutritionalStatsChart: React.FC<NutritionalStatsChartProps> = React.memo(({ data }) => {
